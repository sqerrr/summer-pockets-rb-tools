...
Доказательная база находок из `docs/project/findings.jsonl`. Не для повседневной работы: это воспроизводимые опыты, подтверждающие конкретные утверждения о движке.
